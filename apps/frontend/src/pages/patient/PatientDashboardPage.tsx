      ...
      <section className="mt-6 grid gap-4 lg:grid-cols-2">
        <WorkPanel title="Cuenta del paciente">
          <p className="text-sm leading-6 text-slate-600">
            La cuenta esta lista para consultar disponibilidad y solicitar citas cuando se implemente la gestion de citas.
          </p>
        </WorkPanel>
        <WorkPanel title="Acceso rapido">
          <Link className="inline-flex rounded-md bg-teal-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-teal-800" to="/patient/availability">
            Ver disponibilidad
          </Link>
        </WorkPanel>
      </section>
